// Srishti Studios - Mock Database Storage & Pre-populated AAA content
// This acts as a robust in-memory database fallback if PostgreSQL is not connected.
...
const initialJobs: Job[] = [
  ...
  },
  {
    ...
    requirements: [
      'Portfolo demonstrating AAA-quality environment assets (ZBrush, Substance Painter).',
...
class MockDatabase {
  ...
  public createGame(game: Omit<Game, 'id'>) {
    ...
    this.analytics.gameClicks += 10; // Mock bump
    return newGame;
  }
